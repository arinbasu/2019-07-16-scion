...
venue: "Scion Christchurch"        # brief name of host site without address (e.g., "Euphoric State University")
address: "10 Kyle St, Riccarton, Christchurch 8011 "      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-43.5316108,172.6041045"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "16-17th July, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Arindam Basu", "Anton Angelo", "Joep de Ligt"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Rebecca Turner", "Katharine Melnik"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["megan.guidry@nesi.org.nz", "arindam.basu@canterbury.ac.nz", "Rebecca.Turner@scionresearch.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-07-16-scion            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
http://pad.carpentries.org/2019-07-16-scion
